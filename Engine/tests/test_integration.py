...
from Engine.workers.downloader import DownloadWorker, yt_dlp
...
class MediaIntegrationTests(unittest.TestCase):
    ...
    def test_dispatch_converts_sequential_jobs_in_one_process(self):
        process = subprocess.Popen(
            [sys.executable, str(ROOT / "Engine/__main__.py")], stdin=subprocess.PIPE,
    ...
    def setUpClass(cls):
        ...
        class Handler(BaseHTTPRequestHandler):
            ...
            def do_GET(self):
                ...
                self.send_header("Content-Type", "audio/wav" if self.path.endswith(".wav") else "application/octet-stream")
