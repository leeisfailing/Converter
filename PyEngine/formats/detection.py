...
from PyEngine.formats.video import VIDEO_EXTENSIONS, VIDEO_OUTPUT_FORMATS
from PyEngine.formats.photo import PHOTO_EXTENSIONS, PHOTO_OUTPUT_FORMATS
from PyEngine.formats.audio import AUDIO_EXTENSIONS, AUDIO_OUTPUT_FORMATS
